...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 16, 2017 at 12:48 PM
...
INSERT INTO `file_lamaran` (`id`, `file_lamaran`, `tanggal_upload`, `status_lamaran`, `tanggal_verifikasi`, `keterangan`, `verifikasi_id`, `lowongan_id`, `psikotest`, `test_id`, `user_id`, `pelamar_id`) VALUES
(9, '', '2017-08-16 00:00:00', '2', '2017-08-16 05:30:37', '', 1, 11, '', 0, 48, 1315094);
...
(1383148, '32323232323232323', 'taufik ramdan hidayat', 'Bandung', '2004-02-12', 'Islam', 'L', 'O', 'WNI', 3209, 32, '089672573828', 'Bandung', 0, 2, '1970-01-01', '', '', '', '089672573828', '', 0, 0, 46),
...
--
ALTER TABLE `penilaian_saw`
  MODIFY `id_penilaian_saw` int(11) NOT NULL AUTO_INCREMENT;
--
