...
class OrganisasiController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Organisasi');
	...
	{
		$model=new Organisasi('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Organisasi']))
			$model->attributes=$_GET['Organisasi'];
	...
	{
		$model=Organisasi::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Organisasi $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='organisasi-form')
		{
