...
if($countApplicant==0){ ?>
	...
	<div class="alert alert-info">Belum ada Data Baru dengan status (Pemanggilan) yang masuk pada ID Lowongan #<?php echo $model->id_lowongan; ?></div>
				...
				array(
					...
					'buttons'=>array(
						...
						array(
							...
							'imageUrl'=>YII::app()->baseUrl.'images/sudahdipanggil.png',
							),
																// 'Rekomendasi'=>
																// array(
																// 	'url'=>'Yii::app()->createUrl("filelamaran/rekomendasi", array("id"=>$data->id))',
																// 	'imageUrl'=>YII::app()->baseUrl.'images/rekomendasi.png',
																// 	),
						'Tolak'=>
						array(
