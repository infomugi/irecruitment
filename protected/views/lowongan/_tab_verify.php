...
if($countApplicant==0){ ?>
	...
	<div class="alert alert-info">Belum ada Data Baru dengan status (Verifikasi) yang masuk pada ID Lowongan #<?php echo $model->id_lowongan; ?></div>
				...
				array(
					...
					'buttons'=>array(
						...
						array(
							...
							'imageUrl'=>YII::app()->baseUrl.'images/panggil.png',
							),
														// 'Rekomendasi'=>
														// array(
