...
<?php echo CHtml::link('Tambah',
	array('create'),
	array('class' => 'btn btn-info btn-flat','title'=>'Tambah Jabatan'));
	?>
	<?php echo CHtml::link('List',
		array('index'),
		array('class' => 'btn btn-info btn-flat', 'title'=>'Daftar Jabatan'));
		?>
		<?php echo CHtml::link('Kalola',
			array('admin'),
			array('class' => 'btn btn-info btn-flat','title'=>'Kelola Jabatan'));
			?>
