													...
													<?php if($model->status_lamaran=="Diverifikasi"): ?>
														...
														<?php if($model->file_lamaran==""){ ?>
															...
															<?php }else{ ?>
																...
																<a href="<?php echo Yii::app()->request->baseUrl.'/lamaran/'.$model->file_lamaran; ?>" class="btn btn-danger"><i class="fa fa-download"></i> Download Lamaran</a>

																<!-- START: Jika Psikotest Kosong -->
																<?php if($model->psikotest==""){ ?>

																	<a href="<?php echo Yii::app()->request->baseUrl.'/psikotest/'.$dataBagian->psikotest; ?>" class="btn btn-danger"><i class="fa fa-download"></i> Download Soal Psikotest</a>
																	...
																	<?php }else{ ?>
																		...
																		<a href="<?php echo Yii::app()->request->baseUrl.'/psikotest/'.$model->psikotest; ?>" class="btn btn-danger"><i class="fa fa-download"></i> Download Psikotest Pelamar</a>
