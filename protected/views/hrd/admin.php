...
<div class="alert alert-success">
	<center><h2 class="text-white">Laporan HRD (Personalia) Kab. Bandung disimpan ke Excel, <b class="label label-warning"><a href="<?php echo YII::app()->baseUrl; ?>/Report - Pencari Kerja (<?php echo date('d-m-Y'); ?>).xls"/>Download Laporan</a></b></h2></center>
</div>
