		...
		<?php $form=$this->beginWidget('CActiveForm', array(
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					...
					<?php echo $model->nik; ?>
					<?php
					// $url = "https://devinfokerja.kemnaker.go.id/tools/check_nik/3175025505850025";
					// $json = file_get_contents($url);
					// $data = json_decode($json);
					// echo "<BR>";
					// echo $data->NAMA_LGKP;
					// echo "<BR>";
					// echo $data->JENIS_KLMIN;
					// echo "<BR>";
					// echo $data->AGAMA;
					// echo "<BR>";
					// echo $data->TMPT_LHR;
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						echo $form->radioButtonList($model,'agama',
							array('1'=>'Islam','2'=>'Kristen','3'=>'Katolik','4'=>'Budha','5'=>'Hindu','6'=>'Khonghucu'),
							array(
								'template'=>'{input}{label}',
								'separator'=>'',
								'labelOptions'=>array(
									...
									<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												...
												<?php echo $form->textArea($model,'alamat_domisili',array('class'=>'form-control')); ?>
											</div>
										...
										<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="form-group">
														<div class="col-md-12">  
															<?php echo CHtml::submitButton($model->isNewRecord ? 'Registrasi' : 'Edit Profil', array('class' => 'btn btn-success btn-flat pull-right')); ?>
														</div>
													</div>
