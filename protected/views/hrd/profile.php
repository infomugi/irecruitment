				...
				<div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
					<div class="panel-body">
						...
						<H4><?php echo CHtml::link('<i class="ti-plus"></i>', 
							array('keluarga/create', 'id'=>$model->id_hrd,
			...
			<div class="panel panel-default">
				...
				<div id="2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
					<div class="panel-body">
						...
						<H4><?php echo CHtml::link('<i class="ti-plus"></i>', 
							array('pendidikan/formal', 'id'=>$model->id_hrd,
			...
			<div class="panel panel-default">
				...
				<div id="3" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
					<div class="panel-body">
						...
						<H4><?php echo CHtml::link('<i class="ti-plus"></i>', 
							array('pendidikan/nonformal', 'id'=>$model->id_hrd,
			...
			<div class="panel panel-default">
				...
				<div id="4" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
					<div class="panel-body">
						...
						<H4><?php echo CHtml::link('<i class="ti-plus"></i>', 
							array('bahasa/create', 'id'=>$model->id_hrd,
			...
			<div class="panel panel-default">
				...
				<div id="5" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
					<div class="panel-body">
						...
						<H4><?php echo CHtml::link('<i class="ti-plus"></i>', 
							array('organisasi/create', 'id'=>$model->id_hrd,
			...
			<div class="panel panel-default">
				...
				<div id="6" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
					<div class="panel-body">
						...
						<H4><?php echo CHtml::link('<i class="ti-plus"></i>', 
							array('pekerjaan/create', 'id'=>$model->id_hrd,
				...
				<div id="7" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
					<div class="panel-body">
						...
						<H4><?php echo CHtml::link('<i class="ti-plus"></i> Edit Keahlian', 
							array('keahlian/update', 'id'=>$model->id_hrd,
