...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('username, password, email, level_ID', 'required','on'=>'register_staff'),
			array('password', 'required','on'=>'password_staff'),
			array('date_create', 'default', 'value'=>date('Y-m-d H:i:s'), 'on'=>'register_staff'),
